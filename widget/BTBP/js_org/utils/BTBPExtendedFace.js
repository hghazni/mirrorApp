...
(function(lib) {
	...
	lib.BTBPExtendedFace.prototype.update = function(face) {
	...
	lib.BTBPExtendedFace.prototype.generateExtendedVertices = function(face) {
	...
	lib.BTBPExtendedFace.prototype.generateExtendedTriangles = function(face) {
	...
	lib.BTBPExtendedFace.prototype.updateBounds = function() {
	...
	lib.BTBPExtendedFace.prototype.updatePoints = function() {
	...
	lib.BTBPExtendedFace.prototype.addUpperForeheadPoints = function(v) {
		...
		var baseDist = this.calcDistance(p0, p1) * 1.2;//1.5;
	...
	lib.BTBPExtendedFace.prototype.addToExtendedVertices = function(p) {
		this.vertices.push(p.x);
		this.vertices.push(p.y);
	};

	lib.BTBPExtendedFace.prototype.setPoint 						= lib.BTBPPointUtils.setPoint;
	lib.BTBPExtendedFace.prototype.applyMovementVector 			= lib.BTBPPointUtils.applyMovementVector;
	lib.BTBPExtendedFace.prototype.interpolatePoint 				= lib.BTBPPointUtils.interpolatePoint;
	lib.BTBPExtendedFace.prototype.calcMovementVector 				= lib.BTBPPointUtils.calcMovementVector;
	lib.BTBPExtendedFace.prototype.calcMovementVectorOrthogonalCW 	= lib.BTBPPointUtils.calcMovementVectorOrthogonalCW;
	lib.BTBPExtendedFace.prototype.calcMovementVectorOrthogonalCCW = lib.BTBPPointUtils.calcMovementVectorOrthogonalCCW;
	lib.BTBPExtendedFace.prototype.calcIntersectionPoint 			= lib.BTBPPointUtils.calcIntersectionPoint;
	lib.BTBPExtendedFace.prototype.calcDistance 					= lib.BTBPPointUtils.calcDistance;
