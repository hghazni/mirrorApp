(function() {
	...
	function onSetupChosen(data) {
		btbpExample.init(urlMap[data.value]);
	}

	if(!btbpExample.gui.setupChooser) {

		QuickSettings.useExtStyleSheet();

		btbpExample.gui.setupChooser = QuickSettings.create(
			2, 115, "Setup Chooser", btbpExample.dom.createDiv("_settingsRight"))
			.setWidth(250)
